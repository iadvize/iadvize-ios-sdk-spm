...
/// <code>UIButton</code> subclass allowing Dynamic Type support with custom fonts.
SWIFT_CLASS("_TtC22IAdvizeConversationSDK6Button")
...
@protocol ChatboxControllerDelegate;
...
@property (nonatomic) BOOL useDefaultFloatingButton;
/// The object notified of events related to the conversation such as new messages received.
@property (nonatomic, weak) id <ChatboxControllerDelegate> _Nullable delegate;
/// Set the chat button (the default one) position. Use this method if you use the iAdvize
/// default chat button by setting the <code>useDefaultFloatingButton</code> to <code>true</code>.
...
///
- (void)setFloatingButtonPositionWithLeftMargin:(double)leftMargin bottomMargin:(double)bottomMargin;
...
SWIFT_PROTOCOL("_TtP22IAdvizeConversationSDK25ChatboxControllerDelegate_")
@protocol ChatboxControllerDelegate
@optional
...
- (OngoingConversation * _Nullable)ongoingConversation SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)ongoingConversationUpdatedWithOngoingConversation:(OngoingConversation * _Nullable)ongoingConversation;
@optional
...
/// <code>UIView</code> wrapper around <code>CAGradientLayer</code>.
SWIFT_CLASS("_TtC22IAdvizeConversationSDK12GradientView")
...
SWIFT_CLASS("_TtC22IAdvizeConversationSDK3JWE")
@interface JWE : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end


/// <code>UILabel</code> subclass allowing Dynamic Type support with custom fonts.
SWIFT_CLASS("_TtC22IAdvizeConversationSDK5Label")
@interface Label : UILabel
/// Line height multiple of the label.
@property (nonatomic) IBInspectable CGFloat lineHeightMultiple;
...
- (nonnull instancetype)initWithNewTargetingRuleId:(TargetingRule * _Nonnull)targetingRule OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS_NAMED("ObjcConversationChannel")
@interface ConversationChannel : NSObject
- (void)initWithChat SWIFT_METHOD_FAMILY(none);
- (void)initWithVideo SWIFT_METHOD_FAMILY(none);
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithConversationChannel:(ConversationChannel * _Nonnull)conversationChannel OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC22IAdvizeConversationSDK19OngoingConversation")
@interface OngoingConversation : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
- (void)activateTargetingRuleWithTargetingRule:(TargetingRule * _Nonnull)targetingRule;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC22IAdvizeConversationSDK13TargetingRule")
@interface TargetingRule : NSObject
- (nonnull instancetype)initWithId:(NSUUID * _Nonnull)id objcConversationChannel:(ConversationChannel * _Nonnull)objcConversationChannel OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC22IAdvizeConversationSDK7XibView")
